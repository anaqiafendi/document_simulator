...
| #27 | [Variable-Length Multi-Template Document Generation](feature_variable_length_templates.md) | `synthesis.sections` + `synthesis.document_template` + `synthesis.template_registry` | complete |
