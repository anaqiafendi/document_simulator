...
| #28 | [Receipt Synthesis — React UI + Faker + Augraphy (v0.2)](feature_receipt_synthesis_react_ui.md) | `synthesis.receipts` + `api.routers.receipt_synthesis` + `webapp/.../ReceiptSynthesis` | in-progress |
