...
CATALOGUE: dict[str, dict[str, Any]] = {
    ...
    "NoiseTexturize": {
        ...
        "slow": False,
        "default_params": {"sigma_range": (3, 10), "p": 0.9},
    },
    "ColorShift": {
    ...
    "Watermark": {
        ...
        "phase": "paper",
        "description": "Overlays a faint watermark text or logo.",
        "slow": False,
        "default_params": {"p": 0.9},
    },
    "Jpeg": {
    ...
    "Geometric": {
        ...
        "phase": "post",
        "description": "Applies perspective or affine distortion to the page.",
        "slow": False,
        "default_params": {"p": 0.9},
    },
    "Folding": {
        ...
        "slow": True,  # excluded from auto-thumbnail
        "default_params": {"p": 0.9},
    },
    "BookBinding": {
